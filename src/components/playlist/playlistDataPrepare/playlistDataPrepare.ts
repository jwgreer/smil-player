...
// Used when the platform's file system doesn't populate videoDurationMs — without a
// duration, handleVideoPlay has no fallback timer in its race and the video can be
// stopped early when the next playlist iteration takes over the region.
